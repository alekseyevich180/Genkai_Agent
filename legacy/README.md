...
This directory contains retained standalone research assets that are not active
Genkai package owners.
...
directories are preserved for provenance only and are not imported or packaged
as active Python modules.
