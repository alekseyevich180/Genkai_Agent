...
_FLASH_INSTRUCTION = """
You are Agent, an AI assistant for computational materials science.
...
_NORMAL_INSTRUCTION = """
You are Agent, an AI assistant for computational materials science workflows.
...
_AGENT_INSTRUCTION = "{instruction_body}"
...
thinking_agent = LlmAgent(
    ...
    description=(
        "Agent: plans and executes computational materials science workflows "
