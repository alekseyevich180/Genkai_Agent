"""User-level persistent configuration for Agent.

Config is stored at ~/.agent/config.yaml and controls runtime behaviour
...
_CONFIG_PATH = Path.home() / ".agent" / "config.yaml"
