...
This skill provides guidance for using the Materials Project API in Agent workflows. It is intended for querying known inorganic materials, retrieving crystal structures, checking thermodynamic stability, comparing generated candidates with known database entries.
